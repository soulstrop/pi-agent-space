...
-- at runtime using the environment variable pi_agent_space_bindir.
...
-- environment variable pi_agent_space_libdir.
...
-- using the environment variable pi_agent_space_dynlibdir.
...
-- runtime using the environment variable pi_agent_space_datadir.
...
-- variable pi_agent_space_libexedir.
...
-- using the environment variable pi_agent_space_sysconfdir.
...
bindir     = "/home/mikeco/.cabal/bin"
libdir     = "/home/mikeco/.cabal/lib/x86_64-linux-ghc-9.14.1-87ab/pi-agent-space-0.1.0.0-inplace-pi-agent-space-test"
dynlibdir  = "/home/mikeco/.cabal/lib/x86_64-linux-ghc-9.14.1-87ab"
datadir    = "/home/mikeco/.cabal/share/x86_64-linux-ghc-9.14.1-87ab/pi-agent-space-0.1.0.0"
libexecdir = "/home/mikeco/.cabal/libexec/x86_64-linux-ghc-9.14.1-87ab/pi-agent-space-0.1.0.0"
sysconfdir = "/home/mikeco/.cabal/etc"

getBinDir     = catchIO (getEnv "pi_agent_space_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "pi_agent_space_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "pi_agent_space_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "pi_agent_space_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "pi_agent_space_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "pi_agent_space_sysconfdir") (\_ -> return sysconfdir)
